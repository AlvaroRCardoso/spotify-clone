...
export function Footer() {
    return (
        ...
        <div className='flex items-center gap-3'>
          <Image src="/musica.jpg" width={56} height={56} alt='Capa da música Mágoa e Rancor' />
          <div className='flex flex-col'>
            <strong className='font-normal'>Mágoa e Rancor</strong>
            <span className=' text-xs text-zinc-400'>Mc Ryan SP, KayBlack, MC Caverinha, Vulgo FK</span>
          </div>
        </div>
